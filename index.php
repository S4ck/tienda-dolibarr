...
for($i=0; $i<count($productos); $i++){
    ...
    $imagen_path = 'http://servitelperu.com/intranet/api/index.php/products?sortfield=t.ref&sortorder=ASC&limit=100'.$imagen[0]['level1name'].'/'.$imagen[0]['relativename'].'&entity=1';
